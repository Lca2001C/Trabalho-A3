    ...
    <aside className="fixed left-0 top-0 h-screen hidden md:flex flex-col z-40 transition-all duration-300"
      ...
      <nav className="flex-1 px-0 flex flex-col gap-0.5">
        ...
        <div className="mt-auto mb-6">
          ...
          <button className="flex items-center gap-[10px] py-[9px] px-[18px] w-full transition-all duration-150 group"
                  style={{ color: 'var(--text-secondary)', fontSize: '13px' }}>
            <span className="opacity-60 group-hover:opacity-100"><User size={15} /></span>
            Perfil
          </button>
